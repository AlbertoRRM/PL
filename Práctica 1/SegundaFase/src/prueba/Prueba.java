...
public class Prueba extends Programa {
	...
	public Prueba() {
		programa = prog(
				new Dec[] { decvar(tipoInt(), "x", "linea1"), decvar(tipoInt(), "y", "linea2"),
						decvar(tipoBool(), "z", "linea3") },
				ibloque(new Inst[] {
						iasig("x", suma(suma(cteint(5), cteint(6), "linea 5"), cteint(25), "linea 5"), "linea 5"),
						iasig("y", suma(suma(var("y", "linea 6"), cteint(6), "linea 6"), cteint(25), "linea 6"),
								"linea 6") }));
	}
