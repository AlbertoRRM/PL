...
public abstract class Programa {
	...
	public class DecVar extends Dec {
		private String enlaceFuente; // Indica en qué línea hay un error en el caso de que lo haya
		private String var;
	...
	// Métodos que devuelven el programa, declaraciones, instrucciones, expresiones y tipos.
